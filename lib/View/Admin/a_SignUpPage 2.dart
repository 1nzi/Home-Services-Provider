...
import 'package:home_well/Model/AdminModel/RegisterAdminModel.dart';
import 'package:home_well/View/Admin/a_login.dart';

import 'a_SignUpPage1.dart';



class AdminSignup2 extends StatefulWidget {
  final AdminData bundle;

  const AdminSignup2({Key key, this.bundle}) : super(key: key);

  _AdminSignup2State createState() => _AdminSignup2State();
}
...
Future registerUser(AdminData bundle) async{
  try {
    ...
    DatabaseService(uid: user.uid).updateAdminData(bundle);
