...
import 'a_changePassword.dart';
import 'a_updateAddress.dart';
import 'a_updateEmail.dart';
import 'a_updateGender.dart';
import 'a_updateMobile.dart';
import 'a_updateName.dart';
        ...
        children: <Widget>[
          ...
          ListTile(
            ...
            trailing: IconButton(
                ...
                onPressed: () {
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => AMobile(uid: uid)));
                }),
          ),
          ListTile(
          ...
          ListTile(
            ...
            trailing: IconButton(
                ...
                onPressed: () {
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => AUpdateEmail(uid: uid, uemail:email,)));
                }),
          ),
          ListTile(
